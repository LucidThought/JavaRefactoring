...
public class UserInterface
{
	...
	public String getGenre () // this method gets the movie genre in the form of an integer. it calls the showGenre method to show the list of genres
	{
		showGenre();
		int genreKey = ZERO;
